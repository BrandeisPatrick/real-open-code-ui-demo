...
function renderStepData(stepId) {
    ...
    switch(stepId) {
        ...
        case 8: content = "$ query-model claude-3-7-sonnet\n> Streaming: ACTIVE\n> Chunk: \"Analyzing request...\"\n> Block: <thinking>Targeting query.ts for bug patterns.</thinking>\n> Block: <tool_use name=\"grep_search\" id=\"call_abc123\">\n> Status: Intercepting tool_use for parallel execution..."; break;
